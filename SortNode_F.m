...
index_L_col,index_B_col,index_BL_col,index_INTER_col] = SortNode_F(node_f)
...
node_BL = id_BL;           
DOF_BL = node_BL;           %BottomLeft边界点的自由度
...
node_BR = id_BR;   
DOF_BR = node_BR;           %BottomrRight边界点的自由度
...
node_TR = id_TR;   
DOF_TR = node_TR;           %TopRight边界点的自由度
