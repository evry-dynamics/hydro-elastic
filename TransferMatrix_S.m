function T = TransferMatrix_S(T,DOF_L,DOF_R,DOF_B,DOF_T,DOF_BL,DOF_BR,DOF_TR,...
    DOF_TL,DOF_INTER,index_L,index_B,index_BL,index_INTER,lambda1,lambda2)
% ============================================= %
...
% ============================================= %
    ...
    T(DOF_INTER,index_INTER) =  eye(length(DOF_INTER),length(DOF_INTER));
end